...
namespace CSLMusicMod
{
    ...
    /**
     * 
     * Altered to save RAW PCM files without header 
     * 
     * */
    ...
    public static class SaveWav
    {
        ...
        const int HEADER_SIZE = 0; ///REMOVED
        ...
        public static bool Save(string filename, AudioClip clip)
        {
            ...
            using (var fileStream = CreateEmpty(filepath))
            {
                ...
                //WriteHeader(fileStream, clip); /////////////////////////Removed
            }
        ...
        {
            Debug.Log("[SaveWav] Samples to write: " + clip.samples);
